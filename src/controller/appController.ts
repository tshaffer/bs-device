...
export const initPresentation = (): BsBspVoidThunkAction => {
...
const launchPlayback = (): BsBspVoidThunkAction => {
  return ((dispatch: BsBspDispatch) => {
    dispatch(launchHSM());
  });
};
...
const setPlatform = (): BsBspVoidThunkAction => {
  return ((dispatch: BsBspDispatch) => {
    let platform = '';
    try {
...
const setSrcDirectory = (): BsBspVoidThunkAction => {
